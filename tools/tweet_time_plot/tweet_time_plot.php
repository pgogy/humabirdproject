<?PHP
	...
	class tweet_time_plot extends tool{
			...
			if(!isset($_GET['action'])){
				...
				$output = "<h2>" . $this->language->translate("tools/tweet_time_plot", "Tweet Time Plot") . "</h2>
						   <ul>
								...
								<li>
									<a href='?tool=tweet_time_plot&action=tweet_time_plot_hashtags'>" . $this->language->translate("tools/tweet_time_plot", "Display Tweet time plot (hashtags only)") . "</a>
								</li>
								<li>
		...
		private function tweet_time_plot_hashtags(){
